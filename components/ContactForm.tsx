...
export default function ContactSection() {
  ...
  return (
    <section className="w-full py-24 bg-gradient-to-br from-[#1c1f2b] via-[#181b26] to-[#12141c]">
      <div className="max-w-xl mx-auto p-8 bg-white/5 backdrop-blur-xl rounded-3xl border border-white/10 shadow-2xl">
        <h2 className="text-center text-3xl font-bold mb-4 text-white">Pojďme to probrat</h2>
        ...
        <form className="space-y-5" onSubmit={handleSubmit}>
          ...
          <textarea name="message" placeholder="Stručně popiš svůj projekt*" className="input h-32" required />
          ...
          {success && (
            <p className="text-green-400 text-center mt-2">Zpráva byla odeslána ✅</p>
          )}
